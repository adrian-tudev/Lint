...
bool word_scanner_test(void) {
  ...
  char* lex1 = scan(word_scanner, line1, 0, 1);
  bool ok = strcmp(lex1, "hello") == 0;
  free(lex1);
  if (!ok) return false;

  char* lex2 = scan(word_scanner, line1, 6, 1);
  ...
  char* lex3 = scan(word_scanner, line2, 0, 1);
  ...
  char* lex4 = scan(word_scanner, line3, 0, 1);
  ...
  char* lex5 = scan(word_scanner, line4, 6, 1);
